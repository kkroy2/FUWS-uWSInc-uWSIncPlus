...
if __name__ == '__main__':
    ...
    input_folder = '../Files/accidents_10_9'


    #     input_folder = input('input folder (relative path): ') #+'Files/sign/sign_50_5'
    prefix = '/' + dataset_name + '_'

    #     p0 = float(input('P0 size %: '))
    #     nInc = int(input('Number of increments: '))
    p0 = 20.0
    nInc = 10
    ...
    f_sumname = outputFolder + '/' + dataset_name + '_summary_better' + '.csv'
    ...
    f_detname = input_folder + '/' + dataset_name + '_details_better' + '.csv'
        ...
        for m in mu:
            for w in wghtFact:
                ...
                for i in range(0, num_of_files):
                    ...
                    FileInfo.fs = ffopen(input_folder + '/result/fs_naive_better' + str(i) + '.txt', 'w')
                    FileInfo.sfs = ffopen(input_folder + '/result/sfs_naive_better' + str(i) + '.txt', 'w')
                    ...
                    cnt = 0
                    f = open(input_folder + '/result/fs_naive_better' + str(i) + '.txt', 'r')
                    for line in f:
                        if line == '\n' or line.strip() == '':
                            break
                        cnt += 1
                    ...
                    # print(i,'done')
                final_minWExSup = ThresholdCalculation.get_wgt_exp_sup()
                print('baseline: ', round(final_minWExSup, 10), round(sum(times0), 4), patterns0[len(patterns0) - 1])
                ...
                FileInfo.set_initial_file_info(fname, input_folder + '/result/uWSI_fs0_better.txt',
                                               input_folder + '/result/uWSI_sfs0_better.txt')
                ...
                cnt = 0
                f = open(input_folder + '/result/uWSI_fs0_better.txt', 'r')
                for line in f:
                    if line == '\n' or line.strip() == '':
                        break
                    cnt += 1
                ...
                for i in range(1, num_of_files):
                    FileInfo.fs = open(input_folder + '/result/uWSI_fs_better' + str(i) + '.txt', 'w')
                    FileInfo.sfs = open(input_folder + '/result/uWSI_sfs_better' + str(i) + '.txt', 'w')
                    ...
                    cnt = 0
                    f = open(input_folder + '/result/uWSI_fs_better' + str(i) + '.txt', 'r')
                    for line in f:
                        if line == '\n' or line.strip() == '':
                            break
                        cnt += 1
                ...
                print('uWSInc: ', round(ThresholdCalculation.get_wgt_exp_sup(), 10), round(sum(times1), 4),
                      patterns1[len(patterns1) - 1])

                # uWSInc+##################
                print('uWSInc+')

                fname = input_folder + initFile
                FileInfo.set_initial_file_info(fname, input_folder + '/result/uWSIP_fs0_better.txt',
                                               input_folder + '/result/uWSIP_sfs0_better.txt')
                FileInfo.ls = open(input_folder + '/result/uWSIP_ls0_better.txt', 'w')
                ...
                cnt = 0
                f = open(input_folder + '/result/uWSIP_fs0_better.txt', 'r')
                for line in f:
                    if line == '\n' or line.strip() == '':
                        break
                    cnt += 1
                ...
                for i in range(1, num_of_files):
                    fname = input_folder + prefix + str(i) + '.txt'
                    FileInfo.initial_dataset = open(fname, 'r')
                    FileInfo.fs = open(input_folder + '/result/uWSIP_fs_better' + str(i) + '.txt', 'w')
                    FileInfo.sfs = open(input_folder + '/result/uWSIP_sfs_better' + str(i) + '.txt', 'w')
                    FileInfo.ls = open(input_folder + '/result/uWSIP_ls_better' + str(i) + '.txt', 'w')
                    ...
                    cnt = 0
                    f = open(input_folder + '/result/uWSIP_fs_better' + str(i) + '.txt', 'r')
                    for line in f:
                        if line == '\n' or line.strip() == '':
                            break
                        cnt += 1
                ...
                print('uWSInc+: ', round(ThresholdCalculation.get_wgt_exp_sup(), 10), round(sum(times2), 4),
                      patterns2[len(patterns2) - 1])
                ...
                data = ['-', p0, nInc, th, m, w, final_minWExSup, round(sum(times0), 4), round(sum(times1), 4),
                        round(sum(times2), 4),
